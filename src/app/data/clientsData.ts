...
export const CLIENT_PROGRAMS: ClientProgram[] = [
  ...
  },
  {
    ...
    category: "Academic",
    label: "Cybersecurity Internship Training",
    desc: "Delivered cybersecurity internship training at Solamalai College of Engineering, providing students with practical exposure to cybersecurity concepts, tools, and real-world security practices.",
    participants: "Cybersecurity Internship Training",
  },
  {
    id: 8,
