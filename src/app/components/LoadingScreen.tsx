...
export default function LoadingScreen({ isLoading, onReveal }: { isLoading: boolean; onReveal?: () => void }) {
        ...
        >
          <div className="flex flex-col items-center gap-8">
            <motion.div className="relative w-32 h-32">
              <svg className="w-full h-full" viewBox="0 0 56 58.0457" fill="none">
                <g>
            ...
            >
              ...
              {animationFinished && (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 0.6 }}
                  className="mt-8 text-[#015aaa] text-sm font-medium animate-pulse"
                >
                  Scroll or touch to explore
                </motion.p>
              )}
            </motion.div>
          </div>
