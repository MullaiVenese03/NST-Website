...
export const COMPANY_ICON_MEDIA_DIR = "/media/NST_-_Favicon_[Dark_Transparent]";
export const COMPANY_ICON_MEDIA_DIR_ENCODED =
  "/media/NST_-_Favicon_%5BDark_Transparent%5D";

export const COMPANY_ICON_BASE = `${COMPANY_ICON_MEDIA_DIR}/NST_-_Favicon_[Dark_Transparent]`;
export const COMPANY_ICON_BASE_ENCODED = `${COMPANY_ICON_MEDIA_DIR_ENCODED}/NST_-_Favicon_%5BDark_Transparent%5D`;

/** Root favicons generated by scripts/generate-favicons.mjs */
export const ROOT_FAVICONS = {
  ico: "/favicon.ico",
